 ...
 *@param backgroundColor {string} - is for setting background color of button, '#1974FC' as default e.g, backgroundColor="#1974FC'"
 ...
 *@param borderColor {string} - is for adding border Color, e.g, borderColor="#1974FC"
