...
export const ProfileIcon = ({
  ...
  return (
    <CustomIcon
      ...
      marginLeft={marginLeft ? marginLeft : '11px'}
    />
  );
};
...
export const BriefCaseIcon = ({
  ...
  return (
    <CustomIcon
      size={size ? size : 6}
      cursor="pointer"
      marginTop={marginTop ? marginTop : '9px'}
      marginLeft={marginLeft ? marginLeft : '11px'}
    />
  );
};
...
/** ProgressIcon component where we are passing the Svg components as prop to ant design's Icon component  */
